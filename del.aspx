...
<body style="background-image:url(space.jpg);background-size:cover">
    ...
    <center>
        ...
        <br />
        <br />
        <h1><asp:Label ID="secenten1" runat="server" Text="刪除成功" Font-Names="Ebrima" ForeColor="#FF33CC"></asp:Label></h1>
        <br />
        <br />
        <h3><asp:Label ID="secenten2" runat="server" Text="請問是否要繼續修改或刪除呢"></asp:Label>
            <br />
            <br />
